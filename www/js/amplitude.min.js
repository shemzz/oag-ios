    ...
    function(e, t, a) {
      ...
      var u = a(0),
        ...
        f = (function() {
          ...
          function l(e) {
            0 == e ? o.default.syncMute(!0) : o.default.syncMute(!1),
        ...
        m = (function() {
          function e(e) {
            ...
            if (
              ...
              e.playlists &&
                l(e.playlists) > 0 &&
                ((i.default.playlists = e.playlists),
                m(),
                u(),
                n(),
                d(),
              ...
              var s = {};
              "" != i.default.soundcloud_client
                ? ((s = e), p.default.loadSoundCloud(s))
                : a(e);
            }
            o.default.writeDebugMessage("Initialized With: "),
              o.default.writeDebugMessage(i.default);
          }
          function t() {
            r.default.initializeEvents(), y.default.displaySongMetadata();
          }
          function a(e) {
            void 0 != e.start_song
              ? o.default.isInt(e.start_song)
                ? o.default.changeSong(e.start_song)
                : o.default.writeDebugMessage(
                    "You must enter an integer index for the start song."
                  )
              : o.default.changeSong(0),
              void 0 != e.shuffle_on &&
                e.shuffle_on &&
                ((i.default.shuffle_on = !0),
                o.default.shuffleSongs(),
                y.default.syncShuffle(i.default.shuffle_on),
                o.default.changeSong(i.default.shuffle_list[0].original_index)),
              ...
              y.default.syncVolumeSliders(),
              void 0 != e.default_album_art
                ? (i.default.default_album_art = e.default_album_art)
                : (i.default.default_album_art = ""),
              y.default.resetTimes(),
              y.default.setPlayPauseButtonsToPause(),
              y.default.syncSongsMetaData(),
              e.autoplay &&
                ("" == e.starting_playlist
                  ? (i.default.active_playlist = null)
                  : (i.default.active_playlist = e.starting_playlist),
                y.default.syncMainPlayPause("playing"),
                y.default.syncSongPlayPause(
                  i.default.active_playlist,
                  0,
                  "playing"
                ),
              ...
              "" != e.starting_playlist &&
                ...
                ((i.default.active_playlist = e.starting_playlist),
                o.default.changeSong(e.playlists[e.starting_playlist][0]),
                y.default.syncMainPlayPause("paused"),
                y.default.syncSongPlayPause(
                  i.default.active_playlist,
                  0,
                  "paused"
                )),
              o.default.runCallback("after_init");
          }
          function l(e) {
            var t = 0,
              a = void 0;
          ...
          function u() {
            for (var e in i.default.playlists)
              if (
                i.default.playlists.hasOwnProperty(e) &&
                i.default.playlists[e].songs
              )
                for (var t = 0; t < i.default.playlists[e].songs.length; t++)
                  i.default.songs[i.default.playlists[e].songs[t]] ||
                    o.default.writeDebugMessage(
                      "The song index: " +
                        i.default.playlists[e].songs[t] +
          ...
          function v() {
            for (var e in i.default.playlists)
              y.default.setFirstSongInPlaylist(
                i.default.songs[i.default.playlists[e][0]],
                e
              );
          }
          function m() {
    ...
    function(e, t, a) {
      ...
      var u = a(6),
        ...
        g = (function() {
          ...
          function a() {
            return m.default.active_playlist;
          }
          function l() {
            return m.default.playback_speed;
          }
          function u() {
            return m.default.repeat;
          }
          function n() {
            return m.default.shuffle_on;
          }
          function d(e) {
            return m.default.shuffled_statuses[e];
          }
          function f() {
          ...
          function p() {
            m.default.is_touch_moving ||
              (c.default.setRepeat(!m.default.repeat), v.default.syncRepeat());
          }
          function y() {
            m.default.is_touch_moving ||
              (c.default.setRepeatSong(!m.default.repeat_song),
              v.default.syncRepeatSong());
          }
          function g() {
            return m.default.default_album_art;
          }
          function _(e) {
            m.default.default_album_art = e;
          }
          function h() {
            return (
              (m.default.active_song.currentTime /
                m.default.active_song.duration) *
              100
            );
          }
          function P(e) {
            "number" == typeof e &&
              ...
              e < 100 &&
              (m.default.active_song.currentTime =
                m.default.active_song.duration * (e / 100));
          }
          function b(e) {
            m.default.debug = e;
          }
          function S() {
            return m.default.active_metadata;
          }
          function x(e) {
            return m.default.songs[e];
          }
          function A(e, t) {
            var a = m.default.playlists[e][t];
            return m.default.songs[a];
          }
          function L(e) {
            return (
              void 0 == m.default.songs && (m.default.songs = []),
              m.default.songs.push(e),
              m.default.songs.length - 1
            );
          }
          function M(e, t) {
            void 0 == m.default.songs && (m.default.songs = []),
              m.default.songs.push(e);
            var a = m.default.songs.length - 1;
            return void 0 != m.default.playlists[t]
              ? (m.default.playlists[t].push(a),
                m.default.playlists[t].length - 1)
              : null;
          }
          function k(e) {
            return (
              void 0 != m.default.songs[e] && (m.default.songs.splice(e, 1), !0)
            );
          }
          function E(e, t) {
            if (void 0 == m.default.playlists[t]) return !1;
            m.default.playlists[t].splice(e, 1);
          }
          function T(e) {
            s.default.playNow(e);
          }
          ...
          function O() {
            var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ...
                : null;
            "" == e || null == e
              ? null == m.default.active_playlist ||
                "" == m.default.active_playlist
                ? c.default.setNext()
                : c.default.setNextPlaylist(m.default.active_playlist)
          ...
          function H() {
            ...
            "" == e || null == e
              ? null == m.default.active_playlist ||
                "" == m.default.active_playlist
                ? c.default.setPrev()
                : c.default.setPrevPlaylist(m.default.active_playlist)
              : c.default.setPrevPlaylist(e);
          }
          function D() {
            return m.default.songs;
          }
          function q(e) {
            for (var t = [], a = 0; a < m.default.playlists[e].length; a++)
              t.push(m.default.songs[a]);
            return t;
          }
          function j() {
            return m.default.shuffle_on
              ? m.default.shuffle_list
              : m.default.songs;
          }
          function R(e) {
            var t = [];
            if (m.default.shuffled_status[e])
              for (var a = 0; a < m.default.shuffled_playlists[e].length; a++)
                t.push(m.default.songs[a]);
            else
              for (var l = 0; l < m.default.playlists[e].length; l++)
                t.push(m.default.songs[l]);
            return t;
          }
          function V() {
            return parseInt(m.default.active_index);
          }
          function U() {
            return m.default.shuffle_on
              ? parseInt(m.default.shuffle_active_index)
              : parseInt(m.default.active_index);
          }
          function z() {
            return m.default.version;
          }
          function F() {
            return m.default.buffered;
          }
          function W(e, t) {
            var a =
            ...
            null != a &&
              ...
              s.default.play(),
              v.default.syncMainPlayPause("playing"),
              null != a && v.default.syncPlaylistPlayPause(a, "playing"),
              v.default.syncSongPlayPause(a, t, "playing"),
          ...
          return {
            ...
            getRepeat: u,
            getShuffle: n,
            getShufflePlaylist: d,
            setShuffle: f,
            setShufflePlaylist: r,
            setRepeat: p,
            setRepeatSong: y,
            getDefaultAlbumArt: g,
            setDefaultAlbumArt: _,
            getSongPlayedPercentage: h,
            setSongPlayedPercentage: P,
            setDebug: b,
            getActiveSongMetadata: S,
            getSongByIndex: x,
            getSongAtPlaylistIndex: A,
            addSong: L,
            addSongToPlaylist: M,
            removeSong: k,
            ...
            prev: H,
            getSongs: D,
            getSongsInPlaylist: q,
            getSongsState: j,
            getSongsStatePlaylist: R,
            getActiveIndex: V,
            getActiveIndexState: U,
            getVersion: z,
            getBuffered: F,
            skipTo: W
          };
